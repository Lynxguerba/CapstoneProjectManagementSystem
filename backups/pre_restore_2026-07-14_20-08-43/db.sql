...
INSERT INTO `academic_years` VALUES (1,2022,2023,'A.Y 2022-2023',0,'2026-07-14 10:26:12','2026-07-14 10:26:12'),(2,2023,2024,'A.Y 2023-2024',0,'2026-07-14 10:26:13','2026-07-14 10:26:13'),(3,2024,2025,'A.Y 2024-2025',0,'2026-07-14 10:26:13','2026-07-14 10:26:13');
...
INSERT INTO `cache` VALUES ('cpms-cache-admin@dnsc.ic.ph','i:3;',1784030223),('cpms-cache-admin@dnsc.ic.ph:timer','i:1784030223;',1784030223);
...
--
-- Table structure for table `group_acknowledgement_receipts`
--

DROP TABLE IF EXISTS `group_acknowledgement_receipts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `group_acknowledgement_receipts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `group_id` bigint unsigned NOT NULL,
  `faculty_user_id` bigint unsigned NOT NULL,
  `defense_type_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `faculty_role` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `group_ack_receipt_group_stage_faculty_unique` (`group_id`,`defense_type_key`,`faculty_user_id`),
  KEY `group_acknowledgement_receipts_faculty_user_id_foreign` (`faculty_user_id`),
  KEY `group_acknowledgement_receipts_signed_by_user_id_foreign` (`signed_by_user_id`),
  KEY `group_ack_receipt_group_stage_index` (`group_id`,`defense_type_key`),
  CONSTRAINT `group_acknowledgement_receipts_faculty_user_id_foreign` FOREIGN KEY (`faculty_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `group_acknowledgement_receipts_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `group_acknowledgement_receipts_signed_by_user_id_foreign` FOREIGN KEY (`signed_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `group_acknowledgement_receipts`
--

LOCK TABLES `group_acknowledgement_receipts` WRITE;
/*!40000 ALTER TABLE `group_acknowledgement_receipts` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_acknowledgement_receipts` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `group_defense_verdicts`
--

DROP TABLE IF EXISTS `group_defense_verdicts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `group_defense_verdicts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `group_id` bigint unsigned NOT NULL,
  `stage` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `verdict` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `approved_document_submission_id` bigint unsigned DEFAULT NULL,
  `panelist_user_id` bigint unsigned NOT NULL,
  `decided_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `group_defense_verdicts_group_stage_unique` (`group_id`,`stage`),
  KEY `group_defense_verdicts_approved_document_submission_id_foreign` (`approved_document_submission_id`),
  KEY `group_defense_verdicts_panelist_user_id_foreign` (`panelist_user_id`),
  KEY `group_defense_verdicts_stage_decided_at_index` (`stage`,`decided_at`),
  CONSTRAINT `group_defense_verdicts_approved_document_submission_id_foreign` FOREIGN KEY (`approved_document_submission_id`) REFERENCES `document_submissions` (`id`) ON DELETE SET NULL,
  CONSTRAINT `group_defense_verdicts_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `group_defense_verdicts_panelist_user_id_foreign` FOREIGN KEY (`panelist_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `group_defense_verdicts`
--

LOCK TABLES `group_defense_verdicts` WRITE;
/*!40000 ALTER TABLE `group_defense_verdicts` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_defense_verdicts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `groups` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `approved_concept_submission_id` bigint unsigned DEFAULT NULL,
  `concept_verdict` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `concept_verdict_by_panelist_id` bigint unsigned DEFAULT NULL,
  `concept_verdict_decided_at` timestamp NULL DEFAULT NULL,
  `is_cross_set` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `groups_approved_concept_submission_id_foreign` (`approved_concept_submission_id`),
  KEY `groups_concept_verdict_by_panelist_id_foreign` (`concept_verdict_by_panelist_id`),
  CONSTRAINT `groups_approved_concept_submission_id_foreign` FOREIGN KEY (`approved_concept_submission_id`) REFERENCES `document_submissions` (`id`) ON DELETE SET NULL,
  CONSTRAINT `groups_concept_verdict_by_panelist_id_foreign` FOREIGN KEY (`concept_verdict_by_panelist_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
--
-- Table structure for table `live_defense_comment_highlights`
--

DROP TABLE IF EXISTS `live_defense_comment_highlights`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_defense_comment_highlights` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `live_defense_comment_id` bigint unsigned NOT NULL,
  `highlight_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quote_text` text COLLATE utf8mb4_unicode_ci,
  `comment_emoji` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 0xF09F92AC,
  `content` json DEFAULT NULL,
  `position` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `live_defense_comment_highlights_comment_unique` (`live_defense_comment_id`),
  UNIQUE KEY `live_defense_comment_highlights_highlight_id_unique` (`highlight_id`),
  KEY `live_defense_comment_highlights_highlight_created_index` (`highlight_id`,`created_at`),
  CONSTRAINT `live_defense_comment_highlights_live_defense_comment_id_foreign` FOREIGN KEY (`live_defense_comment_id`) REFERENCES `live_defense_comments` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_defense_comment_highlights`
--

LOCK TABLES `live_defense_comment_highlights` WRITE;
/*!40000 ALTER TABLE `live_defense_comment_highlights` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_defense_comment_highlights` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `live_defense_comments`
--

DROP TABLE IF EXISTS `live_defense_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_defense_comments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `group_id` bigint unsigned NOT NULL,
  `document_submission_id` bigint unsigned NOT NULL,
  `author_id` bigint unsigned DEFAULT NULL,
  `referenced_panelist_id` bigint unsigned DEFAULT NULL,
  `author_role` enum('Student','Adviser','Panelist') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Panelist',
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_highlight_comment` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `live_defense_comments_submission_created_index` (`document_submission_id`,`created_at`),
  KEY `live_defense_comments_group_created_index` (`group_id`,`created_at`),
  KEY `live_defense_comments_author_created_index` (`author_id`,`created_at`),
  KEY `live_defense_comments_referenced_panelist_id_foreign` (`referenced_panelist_id`),
  CONSTRAINT `live_defense_comments_author_id_foreign` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `live_defense_comments_document_submission_id_foreign` FOREIGN KEY (`document_submission_id`) REFERENCES `document_submissions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `live_defense_comments_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `live_defense_comments_referenced_panelist_id_foreign` FOREIGN KEY (`referenced_panelist_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_defense_comments`
--

LOCK TABLES `live_defense_comments` WRITE;
/*!40000 ALTER TABLE `live_defense_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_defense_comments` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `panelist_evaluation_sheet_signatures`
--

DROP TABLE IF EXISTS `panelist_evaluation_sheet_signatures`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `panelist_evaluation_sheet_signatures` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `group_id` bigint unsigned NOT NULL,
  `defense_type_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `panelist_user_id` bigint unsigned NOT NULL,
  `defense_date` date DEFAULT NULL,
  `presenters` json DEFAULT NULL,
  `individual_scores` json DEFAULT NULL,
  `group_scores` json DEFAULT NULL,
  `passing_grade_date` date DEFAULT NULL,
  `signed_at` timestamp NULL DEFAULT NULL,
  `signed_by_user_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `panel_eval_sheet_signature_group_stage_panelist_unique` (`group_id`,`defense_type_key`,`panelist_user_id`),
  KEY `panelist_evaluation_sheet_signatures_panelist_user_id_foreign` (`panelist_user_id`),
  KEY `panelist_evaluation_sheet_signatures_signed_by_user_id_foreign` (`signed_by_user_id`),
  KEY `panel_eval_sheet_signature_group_stage_index` (`group_id`,`defense_type_key`),
  CONSTRAINT `panelist_evaluation_sheet_signatures_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `panelist_evaluation_sheet_signatures_panelist_user_id_foreign` FOREIGN KEY (`panelist_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `panelist_evaluation_sheet_signatures_signed_by_user_id_foreign` FOREIGN KEY (`signed_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `panelist_evaluation_sheet_signatures`
--

LOCK TABLES `panelist_evaluation_sheet_signatures` WRITE;
/*!40000 ALTER TABLE `panelist_evaluation_sheet_signatures` DISABLE KEYS */;
/*!40000 ALTER TABLE `panelist_evaluation_sheet_signatures` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `role_user` VALUES (1,1,NULL,NULL),(2,2,NULL,NULL),(3,3,NULL,NULL),(4,5,NULL,NULL),(5,4,NULL,NULL),(6,6,NULL,NULL),(7,7,NULL,NULL);
...
INSERT INTO `roles` VALUES (1,'Admin','admin','2026-07-14 10:23:39','2026-07-14 10:23:39'),(2,'Student','student','2026-07-14 10:23:39','2026-07-14 10:23:39'),(3,'Adviser','adviser','2026-07-14 10:23:39','2026-07-14 10:23:39'),(4,'Instructor','instructor','2026-07-14 10:23:39','2026-07-14 10:23:39'),(5,'Panelist','panelist','2026-07-14 10:23:39','2026-07-14 10:23:39'),(6,'Dean','dean','2026-07-14 10:23:39','2026-07-14 10:23:39'),(7,'Program Chairperson','program_chairperson','2026-07-14 10:23:39','2026-07-14 10:23:39');
...
INSERT INTO `sessions` VALUES ('TMN1128FrivMW5zSahqIrNsAwqlXvfJZTtMNI7it',NULL,'172.19.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36','',1784029628),('X70EBqkmND8GZkV47kDrPHR7ZU9oaQbInwKbMqhP',NULL,'172.19.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36','',1784029522);
...
INSERT INTO `student_program` VALUES (1,2,'BSIT','2026-07-14 10:26:10','2026-07-14 10:26:10');
...
INSERT INTO `title_categories` VALUES (1,'BSIT','Software Development','Web, mobile, and progressive web applications.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(2,'BSIT','Intelligent Systems','AI, machine learning, and natural language processing projects.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(3,'BSIT','Emerging Technologies','Blockchain, IoT, and AR/VR implementations.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(4,'BSIT','Network & Security','Network tooling, cybersecurity, and security framework projects.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(5,'BSIT','Game Development','Educational games and simulation-focused software.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(6,'BSIS','Enterprise Resource Planning (ERP)','Integrated systems for business operations and workflows.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(7,'BSIS','Decision Support Systems (DSS)','Analytics and business intelligence decision tools.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(8,'BSIS','E-Commerce & Digital Markets','Digital marketplace, CRM, and supply-chain systems.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(9,'BSIS','Information Management & Archiving','Records digitization, routing, and retrieval platforms.','2026-07-14 10:26:13','2026-07-14 10:26:13'),(10,'BSIS','Health or Government Informatics','EMR, e-governance, and public-service informatics systems.','2026-07-14 10:26:13','2026-07-14 10:26:13');
...
INSERT INTO `title_repositories` VALUES (1,'Barangay Service Request Portal with SMS Alerts',1,2,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(2,'Campus Asset Tracking Mobile Application',1,3,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(3,'Student Attrition Risk Predictor using Machine Learning',2,1,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(4,'AI-Based Ticket Classification for IT Helpdesk',2,3,3,'Archived',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(5,'IoT Flood Monitoring with Real-Time Alerting',3,2,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(6,'Blockchain-Based Certificate Verification Platform',3,3,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(7,'Automated Network Incident Response Dashboard',4,1,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(8,'Campus Penetration Testing Toolkit',4,2,3,'Archived',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(9,'Gamified Coding Fundamentals for Senior High',5,3,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(10,'Simulation Game for Disaster Preparedness Training',5,2,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(11,'Integrated Procurement and Inventory ERP for SMEs',6,3,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(12,'HR and Payroll ERP Module for Private Schools',6,2,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(13,'Enrollment Demand Forecast Dashboard',7,1,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(14,'Retail KPI Monitoring and Decision Workbench',7,3,3,'Archived',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(15,'Local Product Marketplace with Supplier Portal',8,2,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(16,'CRM-Integrated Online Distribution Platform',8,3,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(17,'Digital Records Lifecycle and Archiving System',9,1,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(18,'Automated Document Routing for University Offices',9,2,3,'Archived',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(19,'Municipal E-Services and Case Tracking Portal',10,3,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14'),(20,'Electronic Clinic Referral and Patient Queue System',10,2,3,'Approved',NULL,'2026-07-14 10:26:14','2026-07-14 10:26:14');
/*!40000 ALTER TABLE `title_repositories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_notification_states`
--
...
CREATE TABLE `user_notification_states` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `notification_key` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `read_at` timestamp NULL DEFAULT NULL,
  `dismissed_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_notification_states_user_id_notification_key_unique` (`user_id`,`notification_key`),
  KEY `user_notification_states_user_id_dismissed_at_index` (`user_id`,`dismissed_at`),
  CONSTRAINT `user_notification_states_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_notification_states`
--

LOCK TABLES `user_notification_states` WRITE;
/*!40000 ALTER TABLE `user_notification_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_notification_states` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (1,'Admin User','Admin','User','admin@dnsc.ic.ph',NULL,'$2y$12$SRXNlLT3hK4gWDPz3dXUqOMnMhRmUz4lcseY/jsmr4Hv3AA37dF0e',NULL,NULL,NULL,'2026-07-14 10:26:09','2026-07-14 10:26:09','admin','active',NULL),(2,'Student User','Student','User','student@dnsc.ic.ph',NULL,'$2y$12$XruuesdvsFqMwxCtx./QbuIjoNQYFCuDPPjpqVrrRtw0oeLxs0uZS',NULL,NULL,NULL,'2026-07-14 10:26:10','2026-07-14 10:26:10','student','active',NULL),(3,'Adviser User','Adviser','User','adviser@dnsc.ic.ph',NULL,'$2y$12$atQ9DFQuLPwIZLMXlvJBQeK3m3k6ZlotdC6QBFFLmge2hZFXBl25K',NULL,NULL,NULL,'2026-07-14 10:26:10','2026-07-14 10:26:10','adviser','active',NULL),(4,'Panelist User','Panelist','User','panelist@dnsc.ic.ph',NULL,'$2y$12$UnfCUd3cBQpbfItPK3jNM.arPC5ycTJE/45GT648.SpgUuQKQwrgy',NULL,NULL,NULL,'2026-07-14 10:26:11','2026-07-14 10:26:11','panelist','active',NULL),(5,'Instructor User','Instructor','User','instructor@dnsc.ic.ph',NULL,'$2y$12$vj9oMYrwv0eBRx32Vy075.kDcWGlUdxaCfbSuKvzLBEdnwl.85O9q',NULL,NULL,NULL,'2026-07-14 10:26:11','2026-07-14 10:26:11','instructor','active',NULL),(6,'Dean User','Dean','User','dean@dnsc.ic.ph',NULL,'$2y$12$qNBEFGrQV3jMQiquYYTFH.r8L.ybTjxJijTVfPwVsXy57095oeVW2',NULL,NULL,NULL,'2026-07-14 10:26:12','2026-07-14 10:26:12','dean','active',NULL),(7,'Program Chairperson User','Program Chairperson','User','program_chairperson@dnsc.ic.ph',NULL,'$2y$12$k0KnOcfWhErOfnsmcqsANe8twVbn0lW6D.PBLcZEtW4049j3T6fzK',NULL,NULL,NULL,'2026-07-14 10:26:12','2026-07-14 10:26:12','program_chairperson','active',NULL);
...
-- Dump completed on 2026-07-14 12:08:44
