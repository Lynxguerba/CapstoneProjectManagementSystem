...
const DeleteGroupModal = ({ open, groupName, memberCount = 0, processing = false, onClose, onConfirm }: DeleteGroupModalProps) => {
            ...
            >
                <div className="flex items-center justify-between border-b border-rose-200 bg-rose-50 px-4 py-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-rose-900">Delete Group</p>
                ...
                <div className="space-y-3 px-4 py-5">
                    <p className="text-sm text-slate-700">
                        Delete <span className="font-semibold text-slate-900">{groupName}</span>?
                    </p>
                    <div className="rounded-lg border border-rose-200 bg-rose-50 px-3 py-2 text-xs text-rose-700">
                        This group and related records for {memberCount} member{memberCount === 1 ? '' : 's'} will be removed.
                    </div>
                </div>
