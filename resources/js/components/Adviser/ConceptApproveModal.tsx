...
const ConceptApproveModal = ({ open, groupName, conceptTitle, onClose, onConfirm }: ConceptApproveModalProps) => {
            ...
            >
                <div className="flex items-center justify-between border-b border-emerald-200 bg-gradient-to-r from-emerald-50 to-emerald-100 px-4 py-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-bold text-emerald-900">Approve Submission</h2>
                    </div>
                    <button
                        type="button"
                        onClick={onClose}
                ...
                <div className="space-y-4 p-4">
                    ...
                    <p className="text-sm text-slate-600">This will mark the submission as approved (UI only).</p>
...
export default ConceptApproveModal;
