...
type RemoveConceptSubmissionModalProps = {
    open: boolean;
    title: string;
    processing: boolean;
    onClose: () => void;
...
const RemoveConceptSubmissionModal = ({ open, title, processing, onClose, onConfirm }: RemoveConceptSubmissionModalProps) => {
            ...
            >
                <div className="flex items-center justify-between border-b border-gray-200 bg-gradient-to-r from-slate-50 to-slate-100 px-4 py-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-bold text-gray-800">Remove File</h2>
                    </div>
                    <button
                        type="button"
                        onClick={onClose}
                ...
                <div className="p-4">
                    <div className="rounded-lg border border-red-200 bg-red-50 p-3">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <p className="text-sm font-bold text-red-900">Are you sure you want to remove this file?</p>
                                <p className="text-xs text-red-800">
                                    This permanently deletes "{title}" from records and removes the uploaded PDF from storage.
                                </p>
                            </div>
                        </div>
                    </div>
...
export default RemoveConceptSubmissionModal;
