...
interface SaveNotificationModalProps {
    open: boolean;
    onClose: () => void;
    message: string;
    error?: string;
...
const SaveNotificationModal = ({ open, onClose, message, error, onConfirm, isSubmitting }: SaveNotificationModalProps) => {
    const [isAppearing, setIsAppearing] = useState(false);

    const messageLabel = useMemo(() => message.trim(), [message]);
            ...
            >
                <div className="flex items-center justify-between border-b border-gray-200 bg-gradient-to-r from-slate-50 to-slate-100 px-4 py-3">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-bold text-gray-800">Save Notification</h2>
                    </div>
                    <button
                        type="button"
                        onClick={onClose}
                ...
                <div className="p-4">
                    <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 p-3">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <p className="text-sm font-bold text-blue-950">Confirm Notification Update</p>
