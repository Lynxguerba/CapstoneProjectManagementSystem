                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-slate-200 text-slate-600">
                                    <th className="py-3 text-left font-semibold">Deadline</th>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {deadlines.map((d) => (
                                    <tr key={d.id} className="hover:bg-slate-50">
                                        <td className="py-3 font-semibold whitespace-nowrap text-slate-900">{d.name}</td>
                                        <td className="py-3 whitespace-nowrap text-slate-600">{d.scope}</td>
                                        <td className="py-3 whitespace-nowrap text-slate-600">{d.due}</td>
                                ...
                                <div className="space-y-4 p-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="mt-2 h-28 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"
                                        />
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-3 sm:flex-row">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => setOpen(false)}
                                            className="flex-1 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-slate-800 hover:bg-slate-50"
                                        >
                                            Cancel
                                        </button>
                                    </div>
