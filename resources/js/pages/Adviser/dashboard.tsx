                        ...
                        >
                            ...
                            <div className="relative flex h-full flex-col gap-4">
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div className="text-3xl font-bold text-slate-900 transition-transform duration-300 group-hover:scale-105">
                                        {card.value}
                                    </div>
                                    ...
                                    <div className="relative flex-shrink-0">
                                        {/* Glow effect */}
                                        <div
                                            className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${card.tone} opacity-20 blur-xl transition-opacity duration-300 group-hover:opacity-30`}
                                        />

                                        {/* Icon container */}
                                        <div
                                            className={`relative h-12 w-12 rounded-2xl bg-gradient-to-br ${card.tone} flex items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl`}
                                        >
                                ...
                                {/* Label at bottom */}
                                <div className="overflow-hidden text-sm font-semibold text-ellipsis whitespace-nowrap text-slate-600">
                                    {card.label}
                                </div>
                            </div>
                ...
                >
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">Fast navigation to your most common tasks (UI only).</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        {[
                            ...
                            <a
                                key={a.label}
                                href={a.href}
                                className="group rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 transition-shadow hover:shadow-md"
                            >
                                <div className="flex items-start justify-between gap-3">
                                    <div>
                                    ...
                                    <div
                                        className={`h-10 w-10 rounded-2xl bg-gradient-to-br ${a.tone} flex items-center justify-center shadow-sm transition-transform group-hover:scale-[1.02]`}
                                    >
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">Line chart showing mock review throughput.</p>
                            </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">Concepts and documents status.</p>
                            </div>
                            <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-semibold text-slate-600">
                                MUI X Charts
                            </span>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-2">
                        <div className="flex items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">Next events involving your assigned groups.</p>
                            </div>
                            <a
