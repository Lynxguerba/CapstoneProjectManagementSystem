                ...
                >
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <div className="flex gap-2">
                            <button
                                type="button"
                                onClick={() => alert('UI only: download PDF')}
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
                            <pre className="font-sans text-sm whitespace-pre-wrap text-slate-800">{minutesText}</pre>
                        </div>
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-6">
                            ...
                            <input
                                ...
                                className="mt-4 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"
                            />
                            ...
                            <button
                                ...
                                className="mt-4 w-full rounded-xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                Approve minutes
                            </button>
