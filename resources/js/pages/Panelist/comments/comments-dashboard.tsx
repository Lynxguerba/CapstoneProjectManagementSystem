                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-slate-200 text-slate-600">
                                    ...
                                    <th className="py-3 text-left font-semibold">Page/Section</th>
                                    <th className="py-3 text-left font-semibold">Type</th>
                                    <th className="py-3 text-left font-semibold">Preview</th>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {comments.map((c) => (
                                    <tr key={c.id} className="hover:bg-slate-50">
                                        <td className="py-3 font-medium whitespace-nowrap text-slate-900">{c.group}</td>
                                        <td className="min-w-[220px] py-3 text-slate-700">{c.document}</td>
                                        <td className="py-3 whitespace-nowrap text-slate-700">{c.pageRef}</td>
                                        <td className="py-3">
                                            <span
                                                className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold ${pill(c.type)}`}
                                            >
                                                {c.type}
                                            </span>
                                        </td>
                                        <td className="min-w-[260px] py-3 text-slate-700">{c.preview}</td>
                                        <td className="py-3 whitespace-nowrap text-slate-700">{c.dateAdded}</td>
                                        <td className="py-3">
