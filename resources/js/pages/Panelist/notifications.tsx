    ...
    const notifications: NotificationItem[] = [
        {
            ...
            message: 'You were assigned to Group Alpha (Outline).',
            date: '2026-03-10',
            tone: 'info',
            isRead: false,
            type: 'assignment',
        },
        {
            ...
            message: 'Group Beta uploaded Proposal Manuscript.',
            date: '2026-03-12',
            tone: 'info',
            isRead: true,
            type: 'document',
        },
        {
            ...
            message: 'Outline Defense for Group Alpha is in 2 days.',
            date: '2026-03-19',
            tone: 'warning',
            isRead: false,
            type: 'schedule',
        },
        {
            ...
            message: 'Your evaluation for Group Delta has been submitted.',
            date: '2026-03-11',
            tone: 'success',
            isRead: true,
            type: 'verdict',
            ...
            <div className="space-y-6">
                ...
                >
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
                        {filtered.map((n) => (
                            <div key={n.id} className={`rounded-2xl border bg-white p-5 ${toneStyles[n.tone]}`}>
