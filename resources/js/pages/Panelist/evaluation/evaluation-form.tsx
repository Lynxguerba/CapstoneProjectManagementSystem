        ...
        <PanelLayout title="Evaluation & Scoring" subtitle="Submit scores after defense (UI only)">
            <div className="space-y-6">
                ...
                >
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div className="w-full lg:w-80">
                            <select
                                ...
                                className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"
                            >
                                {groups.map((g) => (
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 lg:col-span-2">
                            <div className="text-xs font-semibold tracking-wide text-slate-500 uppercase">Defense Info</div>
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-5">
                            <div className="text-xs font-semibold tracking-wide text-slate-500 uppercase">Total Score</div>
                            <div className="mt-2 text-3xl font-bold text-slate-900 tabular-nums">
                                {total} / {maxTotal}
                            </div>
                            <div className="mt-3">
                                <span
                                    className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold ${scorePill(percent)}`}
                                >
                                    {percent}%
                                </span>
                            </div>
                ...
                >
                    ...
                    <div className="mt-1 text-sm text-slate-500">Score each criterion from 1–10.</div>
                ...
                >
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-2">
                        ...
                        <div className="mt-1 text-sm text-slate-500">Strengths, improvements, recommendations.</div>
                        <textarea
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div className="mt-1 text-sm text-slate-500">Recommend the outcome.</div>
                        ...
                        <div className="mt-6 flex flex-col gap-3">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2.5 text-sm font-semibold text-white hover:shadow"
                            >
