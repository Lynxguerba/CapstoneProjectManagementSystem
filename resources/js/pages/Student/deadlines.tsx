                ...
                >
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">Countdown UI placeholder (backend will compute later).</p>
                        </div>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {deadlines.map((d) => (
                                    <tr key={d.id} className="hover:bg-slate-50">
                                        ...
                                        <td className="py-3">
                                            <span
                                                className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold ${toneMeta[d.tone].pill}`}
                                            >
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
                        {notifications.map((n) => (
                            <div key={n.id} className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-4">
                                <div className="text-xs font-semibold tracking-wide text-slate-500 uppercase">{n.date}</div>
