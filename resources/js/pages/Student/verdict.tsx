            ...
            <div className="space-y-6">
                ...
                >
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            <div className="text-xs font-semibold tracking-wide text-slate-500 uppercase">Final Verdict</div>
                ...
                >
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <p className="mt-1 text-sm text-slate-500">Shown when re-defense is required.</p>

                        <div className="mt-5 space-y-3">
                            {revisions.map((r) => (
                                <div key={r} className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                                    {r}
                                </div>
                            ))}
                        </div>
