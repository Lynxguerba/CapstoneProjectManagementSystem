                            ...
                            <tbody className="divide-y divide-slate-100">
                                {schedule.map((s) => (
                                    <tr key={s.type} className="hover:bg-slate-50">
                                        <td className="py-3 font-medium whitespace-nowrap text-slate-900">{s.type}</td>
                                        <td className="py-3 whitespace-nowrap text-slate-600">{s.date}</td>
                                        ...
                                        <td className="min-w-[220px] py-3 text-slate-600">{s.panel.join(', ')}</td>
                                        <td className="py-3">
                                            <span
