...
const AcknowledgementReceiptPage = () => {
    ...
    return (
        <StudentLayout title="Acknowledgement Receipt" subtitle="Capstone project defense payment verification (view-only)">
            <motion.section initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }} className="space-y-5">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-slate-500">
                    ...
                    <Link href="/student/live-defense" className="font-medium text-slate-600 transition-colors hover:text-slate-900">
                        Live Defense
                    </Link>
                    <ChevronRight className="h-3 w-3 text-slate-400" />
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <Link
                            href={`/student/live-defense${groupQuery}`}
                ...
                <div className="rounded-xl border border-slate-300 bg-white p-4 shadow-sm sm:p-7">
                    ...
                    <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-[11px] text-slate-600">
                        ...
                        <p className="mt-1">Student view is read-only. Faculty signatures are shown here when submitted.</p>
                    </div>
                </div>
            </motion.section>
        </StudentLayout>
