                ...
                >
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">Track your capstone phase from concept to archiving.</p>
                        </div>
                        <button
                            type="button"
                                    ...
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <div
                                            className={`flex h-9 w-9 items-center justify-center rounded-xl ${
                                                isCurrent ? 'bg-indigo-600' : isDone ? 'bg-emerald-600' : 'bg-slate-400'
                                            }`}
                                        >
                                            {isDone ? (
                    ...
                    {statusCards.map((card, idx) => (
                        ...
                        >
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    <div className="text-xs font-semibold tracking-wide text-slate-500 uppercase">{card.title}</div>
                ...
                >
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">Graphs are UI-only using dummy data.</p>
                        </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-2">
                        <div className="flex items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">Next events you need to attend.</p>
                            </div>
                            <button
                                type="button"
                                onClick={() => alert('UI only: go to defense schedule page')}
                                className="rounded-xl bg-gradient-to-r from-slate-800 to-slate-700 px-4 py-2.5 text-sm font-medium text-white hover:shadow-lg"
                            >
                                Open schedule
                            </button>
                        </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">Stay compliant and on track.</p>
                            </div>
                        ...
                        <div className="mt-5 space-y-3">
                            {deadlines.map((d) => (
                                <div key={d.name} className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-4">
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="truncate text-sm font-semibold text-slate-900">{d.name}</div>
                                        <span
                                            className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold ${deadlinePill(d.status === 'near' ? 'near' : 'on_track')}`}
                                        >
