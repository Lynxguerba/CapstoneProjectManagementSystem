...
type InstructorNotificationsProps = {
...
const NotificationsPage = () => {
    const { props } = usePage<InstructorNotificationsProps>();
    ...
    const markAsRead = (notificationKey: string) => {
        mutateNotification(notificationKey, 'patch', `/instructor/notifications/${encodeURIComponent(notificationKey)}/read`);
    };

    const dismissNotification = (notificationKey: string) => {
        mutateNotification(notificationKey, 'delete', `/instructor/notifications/${encodeURIComponent(notificationKey)}`);
    };
    ...
    return (
        <InstructorLayout title="Notifications" subtitle="Track announcements, document updates, and defense schedule activity.">
