...
const GroupDocumentsPage = () => {
    ...
    return (
        <InstructorLayout title="Group Documents" subtitle="Review concept paper submissions from your groups">
            <div className="space-y-6">
                ...
                <div className="text-1xl font-bold text-slate-900">
                    Concept Documents Review : <span className="font-semibold text-slate-900">Group</span> {activeGroup?.name ?? 'No group selected'}
                </div>
                {activeGroup?.adviser ? (
